...
Security fixes are applied to the latest released minor version. Before the first stable release, only the current `main` branch is supported.
...
We aim to acknowledge a report within five business days, provide an initial assessment within ten business days, and coordinate disclosure after a fix is available. These are targets, not contractual service levels.
