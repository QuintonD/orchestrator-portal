...
Start with the [documentation index](docs/README.md), especially [desktop setup](docs/desktop.md), [Android setup](docs/android.md), and [deployment](docs/deployment.md).

| Request | Where to go |
| --- | --- |
| Setup help, usage questions, or ideas to explore | [GitHub Discussions](https://github.com/QuintonD/orchestrator-portal/discussions) |
| Reproducible defect | [Bug report](https://github.com/QuintonD/orchestrator-portal/issues/new?template=bug.yml) |
...
Support is community-based; there is no guaranteed response time. Source runtimes own their execution and permission behavior. If a problem is specific to a runtime, include its version and explain what differs when using it directly.
